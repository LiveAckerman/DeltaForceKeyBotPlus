...
os.environ["TESSDATA_PREFIX"] = r"D:\my_project\DeltaForceKeyBot-main\tessdata-4.1.0"
...
def getCardPrice():
    ...
    region_left = int(screen_width * 0.856)
    region_top = int(screen_height * 0.80)
    region = (region_left, region_top+20, region_width -40, region_height-20)
